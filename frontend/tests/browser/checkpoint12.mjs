...
await click('+5 bars');await pause(700);await click('Previous');await waitFor(`document.querySelector('.replay-toolbar').innerText.includes('09:36')&&[...document.querySelectorAll('button')].some(b=>b.textContent==='Load replay'&&!b.disabled)`);
